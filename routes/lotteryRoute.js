...
export const lotteryRoutes = (app) => {
  ...
  app.delete('/api/lotteries/delete-non-purchased', authorize([string.Admin]), deleteNonPurchasedLotteries);
  ...
  app.put(
    '/api/edit-particularLottery/:lotteryId',
    validateEditLottery,
    customErrorHandler,
  ...
  app.delete(
    '/api/delete-particularLottery/:lotteryId',
    validateGetLotteryById,
    customErrorHandler,
    authorize([string.Admin]),
    deleteLottery,
