...
import { adminPurchaseHistory, adminSearchTickets, createAdmin, createDrawDate, getDrawDate, login } from "../controllers/admin.controller.js";
...
export const adminRoutes = (app) => {
    ...
    app.post('/api/admin/draw-dates',authorize([string.Admin]), createDrawDate);
    app.get('/api/admin/draw-date', authorize([string.Admin]), getDrawDate)
